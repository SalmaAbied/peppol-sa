  ...
  return (
    <div>
      <header className="relative container lg:mt-20" style={{ minHeight: minHeight }}>
        <img 
          src="https://images.unsplash.com/photo-1590649613897-1d5c44ca3409?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" 
          alt="Shapes" 
        ...
        <div className="absolute inset-0 flex justify-center items-center text-center">
          <div>
            <h1 className="text-white text-2xl lg:text-4xl font-bold">{t('Ondernemers.Header.Title')}</h1>
            <p className="text-white text-sm lg:text-base">{t('Ondernemers.Header.Subtitle')}</p>
          </div>
        </div>
      </header>
    </div>
