...
const Item: React.FC<ItemProps> = ({
  ...
  return (
    <div className="item overflow-hidden bg-white">
      <div className="text-gray-dark font-medium overflow-hidden">
        <button
          type="button"
          role="button"
          id={questionID}
          className={`w-full flex gap-4 items-center justify-between p-5 transition-colors duration-100 ease-in hover:${backgroundColor ? backgroundColor : "bg-orange-100"} ${
