export const blogPosts: BlogPost[] = [
  {
    ...
    subtitle: "Peppol",
    articleTitle: "E-facturatie vanaf 2026 verplicht in België",
    articlePartOne: {
      title: "Wat is e-facturatie?",
      content: "E-facturatie is meer dan facturen in pdf-formaat versturen per mail. Als we het over e-facturatie of e-invoicing hebben, verwijst dit in de eerste plaats naar gestructureerde elektronische facturen in UBL-formaat volgens de Europese Peppol-standaard. Anders gezegd, de factuur wordt in een specifiek formaat meteen herkend en verwerkt door ERP of boekhoudingsoftware. Het is met andere woorden van belang om jouw huidige software aan te passen waardoor e-facturatie mogelijk wordt."
    },
    articlePartTwo: {
    ...
    extraImg: require("../components/img/blog/blogpost1.nl.png"),
    extraImg1: require("../components/img/blog/blogpost1.nl.png")
  },
  {
    id: '2',
    date: "11 april 2024",
    title: "E-facturatie (Peppol) vanaf 2026 verplicht in België",
    subtitle: "Boekhouders",
    articleTitle: "Title",
    articlePartOne: {
      title: "Introduction",
      content: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Obcaecati ipsa soluta debitis quisquam, nobis aspernatur at unde reprehenderit nulla dolores, cupiditate ad voluptate consequuntur iusto molestiae magnam voluptas eveniet doloribus!"
    },
    articlePartTwo: {
      title: "Main Body",
      content: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Obcaecati ipsa soluta debitis quisquam, nobis aspernatur at unde reprehenderit nulla dolores, cupiditate ad voluptate consequuntur iusto molestiae magnam voluptas eveniet doloribus!"
    ...
    extraImg: "https://images.unsplash.com/photo-1533632638678-bb4b484689a7?q=80&w=1932&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
  },
  {
    id: '3',
    date: "11 april 2024",
    title: "E-facturatie (Peppol) vanaf 2026 verplicht in België",
    subtitle: "Ondernemers",
    articleTitle: "Title",
    articlePartOne: {
      title: "Introduction",
      content: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Obcaecati ipsa soluta debitis quisquam, nobis aspernatur at unde reprehenderit nulla dolores, cupiditate ad voluptate consequuntur iusto molestiae magnam voluptas eveniet doloribus!"
...
export const blogPostTranslations:Translation = {
  "1": {
    nl: {
      ...
      category: "Peppol",
      imageUrl: "https://img.freepik.com/free-photo/shipping-document-laptop-connection-homepage_53876-138115.jpg?t=st=1713357304~exp=1713360904~hmac=f74c4be16d6b74d1a8b61304965889ca4e12493a1e41722584208238d92a1001&w=1380",
      extraImg: require("../components/img/blog/blogpost1.nl.png"),
      extraImg1: require("../components/img/blog/blogpost1.1.nl.png")
    },
    fr: {
      date: "17 avril 2024",
      title: "La facturation électronique (Peppol) obligatoire en Belgique à partir de 2026",
      subtitle: "Peppol",
      articleTitle: "La facturation électronique obligatoire en Belgique à partir de 2026",
      articlePartOne: {
      ...
      category: "Peppol",
      imageUrl: "https://img.freepik.com/free-photo/shipping-document-laptop-connection-homepage_53876-138115.jpg?t=st=1713357304~exp=1713360904~hmac=f74c4be16d6b74d1a8b61304965889ca4e12493a1e41722584208238d92a1001&w=1380",
      extraImg: require("../components/img/blog/blogpost1.fr.png"),
      extraImg1: require("../components/img/blog/blogpost1.1.fr.png")
    },
  },
};
